  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Hero Section */}
        ...
        className="container mx-auto px-8 py-20 max-w-5xl"
      >
        <div className="text-center mb-20">
          <h1 className="text-4xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Our Portfolio</h1>
            ...
            return (
              ...
              <motion.div 
                key={project.id}
                      ...
                      className="bg-blue-500/5 border border-blue-500/20 rounded-lg p-6 flex flex-col justify-between shadow-lg"
                    >
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          {project.tags.map(tag => (
                            <span key={tag} className="px-3 py-1 text-xs bg-blue-500/20 text-blue-200 rounded-full font-medium">
                              {tag}
                            </span>
                          ))}
                        </div>
                        ...
                        {project.url && (
                          <Button asChild size="sm" variant="secondary">
                            <Link href={project.url} target="_blank" rel="noopener noreferrer">
                              Live <ExternalLink className="ml-1 h-4 w-4 inline" />
                            </Link>
                          </Button>
                        )}
                      </div>
        ...
        >
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-300">Let's build something amazing together. Book a free strategy call today!</p>
          </div>
          <Button asChild size="lg" className="bg-blue-600 hover:bg-blue-700 text-white rounded-full px-8 py-3 text-lg font-semibold">
