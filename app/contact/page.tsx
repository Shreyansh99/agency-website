...
export default function ContactPage() {
  return (
    <>
      <NextSeo
        title="Contact WebNexaAI | Book a Free AI Strategy Call"
        description="Get in touch with WebNexaAI to discuss your project, book a free strategy call, or learn more about our AI solutions."
        canonical="https://webnexaai.com/contact"
      />
      <main className="min-h-screen relative">
        ...
        <section aria-label="Contact Info & Form">
              ...
              <Card className="bg-blue-500/5 border border-blue-500/20 rounded-lg order-2 lg:order-1">
                ...
                <CardContent className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h2 className="text-lg font-medium text-white">Phone</h2>
        ...
        {/* Internal links at the end of the contact page */}
        <div className="mt-12 text-center text-blue-300 text-sm">
          <p>Want to learn more? <Link href="/services" className="underline hover:text-blue-400">Explore our AI automation & marketing services</Link>, <Link href="/portfolio" className="underline hover:text-blue-400">see our client results</Link>, or <Link href="/blog" className="underline hover:text-blue-400">read our blog</Link>.</p>
        </div>
      </main>
    </>
  );
