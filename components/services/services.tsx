...
export const services = [
  ...
  },
  {
    icon: Bot,
    title: "AI Automation",
    subtitle: "Save hours with automated workflows that run your ops.",
    content: [
      "✅ CRM & lead form integrations",
      "✅ WhatsApp, Email, and Slack triggers",
      "✅ Airtable, Notion, Google Sheets updates",
  ...
  },
  {
    ...
    subtitle: "Smart agents that book, qualify, and support — 24/7.",
    content: [
      "✅ AI Sales Assistant",
      "✅ AI Lead Qualifier",
      "✅ AI Booking Agent",
  ...
  },
  {
    icon: MessageSquare,
    title: "AI Chatbots",
    subtitle: "GPT bots that convert visitors into leads — hands-free.",
    content: [
      "✅ Custom logic trained on your data",
      "✅ Integrations: Calendly, Typeform, WhatsApp, Telegram",
  ...
  },
  {
    ...
    subtitle: "Content, ads & lead nurturing — all powered by AI.",
    content: [
      "✅ Instagram Reels, posts, captions",
      "✅ Meta & Google Ads (A/B tested creatives)",
      "✅ Full-funnel automation & landing pages",
      "✅ AI content generation for fast scaling",
  ...
  },
  {
    ...
    title: "AI-Generated Product Ads",
    subtitle: "Creative content built instantly with AI.",
    content: [
      "✅ AI-generated product visuals",
      "✅ Captions, ad copy, CTAs",
